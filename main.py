...
UPDATE_CHNL = os.environ.get("UPDATE_CHNL","FuckerEx")
OWNER_USERNAME = os.environ.get("OWNER_USERNAME","FuckerEx")
SUPPORT_GRP = os.environ.get("SUPPORT_GRP","BoochiiWorld")
BOT_NAME = os.environ.get("BOT_NAME","Sweetie")
